...
export interface Env {
  X402API_TENANT_API_KEY?: string | undefined;

  X402API_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodMiniType<Env, unknown> = z.object({
  X402API_TENANT_API_KEY: z.optional(z.string()),

  X402API_DEBUG: z.optional(z.coerce.boolean()),
});
